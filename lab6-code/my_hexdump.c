...
#define BOOT_CMDLINE_ADDR 0xffffffff97f62920
#define SAVED_CMDLINE_ADDR 0xffffffff980e9008
#define TEST_LEN 50 
static int __init show_cmdline(void)
{
...
#ifdef SAVED
	print_hex_dump(KERN_ALERT, "SAVED_CMDLINE_CONTENT:", DUMP_PREFIX_ADDRESS,
			32, 4, (void*)*saveaddr, TEST_LEN, true);
#else
	print_hex_dump(KERN_ALERT, "BOOT_CMDLINE_CONTENT:", DUMP_PREFIX_ADDRESS,
			32, 4, (void*)*bootaddr, TEST_LEN, true);
#endif
	return 0;
}

static void __exit exit_show(void)
{
	printk(KERN_ALERT "Ending print process.......\n");
}
module_init(show_cmdline);
module_exit(exit_show)
